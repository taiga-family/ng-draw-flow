...
class OverviewComponent {
  constructor() {
    ...
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__.FormControl(this.data, [(0,_ng_draw_flow_core__WEBPACK_IMPORTED_MODULE_1__.dfCycleDetectionValidator)(), (0,_ng_draw_flow_core__WEBPACK_IMPORTED_MODULE_1__.dfIsolatedNodesValidator)()]);
  }
}
_OverviewComponent = OverviewComponent;
_OverviewComponent.ɵfac = function OverviewComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _OverviewComponent)();
};
_OverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  ...
  template: function OverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](1, " This is an overview example of the capabilities of NgDrawFlow. Below, you can observe that nodes can contain absolutely anything inside. ");
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](2, "section", 1)(3, "tui-doc-example", 2)(4, "div", 3);
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelement"](5, "ng-draw-flow", 4);
  ...
  styles: [".editor-overview {\n  block-size: 40rem;\n  inline-size: 100%;\n  margin: 0 auto;\n  background: #fff;\n}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
  encapsulation: 2,
  changeDetection: 0
});
