...
export const appRoutes: Routes = [
    ...
    },
    {
        ...
        data: {title: 'Terms and Definitions'},
    },
    {
        path: DemoPath.ConfigurationAndPublicApi,
        loadComponent: async () =>
            import('../pages/documentation/configuration-and-public-api/configuration-and-public-api.component'),
