...
class SimpleExampleComponent {
  constructor() {
    this.gettingStartedExample = {
      ...
      Template: __webpack_require__.e(/*! import() */ "projects_demo_src_pages_examples_simple-example_examples_template_html_raw").then(__webpack_require__.t.bind(__webpack_require__, /*! ./examples/template.html?raw */ 1394, 17))
    };
    this.data = {
