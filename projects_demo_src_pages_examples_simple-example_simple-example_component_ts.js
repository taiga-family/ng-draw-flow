...
class SimpleExampleComponent {
  constructor() {
    this.gettingStartedExample = {
      TypeScript: __webpack_require__.e(/*! import() */ "projects_demo_src_pages_examples_simple-example_examples_component_ts_raw").then(__webpack_require__.t.bind(__webpack_require__, /*! ./examples/component.ts?raw */ 69568, 17)),
...
_SimpleExampleComponent.ɵfac = function SimpleExampleComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SimpleExampleComponent)();
};
_SimpleExampleComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  ...
  styles: [".editor[_ngcontent-%COMP%] {\n  block-size: 25rem;\n  inline-size: 100%;\n  margin: 0 auto;\n  background: #fff;\n}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
  changeDetection: 0
});
