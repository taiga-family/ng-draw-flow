...
/* harmony import */ var _taiga_ui_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @taiga-ui/core */ 11498);
/* harmony import */ var _taiga_ui_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @taiga-ui/core */ 21028);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ 79746);
/* harmony import */ var _app_modules_nodes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../app/modules/nodes */ 85989);
/* harmony import */ var _taiga_ui_addon_doc_components__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @taiga-ui/addon-doc/components */ 94841);
/* harmony import */ var _taiga_ui_kit__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @taiga-ui/kit */ 31200);
/* harmony import */ var _taiga_ui_core__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @taiga-ui/core */ 50957);
...
class EditorComponent {
  ...
  ngOnInit() {
    ...
    this.scaleControl.valueChanges.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_5__.distinctUntilChanged)(), (0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(value => {
      if (!Number.isFinite(value)) {
        return;
      }
      this.drawFlowStore.setScale(value);
    });
    this.drawFlowStore.connectionCreated$.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(data => {
      console.warn(data, 'drawFlowStore connectionCreated');
    });
    this.drawFlowStore.connectionDeleted$.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(data => {
      console.warn(data, 'drawFlowStore connectionDeleted');
    });
    this.drawFlowStore.connectionSelected$.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(data => {
      console.warn(data, 'drawFlowStore connectionSelected');
    });
    this.drawFlowStore.nodeDeleted$.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(data => {
      console.warn(data, 'drawFlowStore nodeDeleted');
    });
    this.drawFlowStore.nodeMoved$.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(data => {
      console.warn(data, 'drawFlowStore nodeMoved');
    });
    this.drawFlowStore.nodeSelected$.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_6__.takeUntilDestroyed)(this.destroyRef)).subscribe(data => {
...
_EditorComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  ...
  dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.AsyncPipe, _angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgClass, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, ngx_markdown__WEBPACK_IMPORTED_MODULE_8__.MarkdownModule, _ng_draw_flow_core__WEBPACK_IMPORTED_MODULE_0__.NgDrawFlowComponent, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.ReactiveFormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControlDirective, _taiga_ui_addon_doc_components__WEBPACK_IMPORTED_MODULE_9__.TuiDocExample, _taiga_ui_addon_doc_components__WEBPACK_IMPORTED_MODULE_9__.TuiDocPage, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_10__.TuiButton, _taiga_ui_kit__WEBPACK_IMPORTED_MODULE_11__.TuiInputNumberDirective, _taiga_ui_kit__WEBPACK_IMPORTED_MODULE_11__.TuiInputNumberStep, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_12__.TuiLabel, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_13__.TuiTextfieldComponent, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_13__.TuiTextfieldOptionsDirective],
